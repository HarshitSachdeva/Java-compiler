        ...
        if(e.getSource()==jbcompile) {
            ...
            if(!jtf.getText().equals("")) {
                try{
                    ...
                    pw.println(s1);
                    pw.flush();
                    Process error=r.exec("C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\javac.exe -d . "+fname);
                    ...
                    if(result.equals("")) {
                        jta.setText("Compilation successfull:: "+fname);
                        err.close();
                    }
                    else
                        jta1.setText(result);
            ...
            try {
                ...
                Process p=r.exec("C:\\Program Files\\Java\\jdk1.8.0_60\\bin\\java "+fn);
...
class MyFocusListener extends FocusAdapter {
    MyEditor e;
     ...
     public void focusGained(FocusEvent fe) {
        ...
        if (str.equals("")) {
            e.jta1.setText("Class name required");
        } else {
            e.jta1.setText("");
